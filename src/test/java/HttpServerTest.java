...
public class HttpServerTest {
    ...
    public void invalidKey() throws Exception {
        testSend(AirlockMessageGenerator.generateAirlockMessage("project.env2.a"), HttpStatus.SC_BAD_REQUEST);
    }
    ...
    public void invalidMethod() throws Exception {
        Request request = Request.Get("http://localhost:" + port + "/send")
                ...
                .socketTimeout(5000);
        HttpResponse response = request.addHeader("x-apikey", "WildcardPatternApiKey").execute().returnResponse();
    ...
    public void wrongApiKey() throws Exception {
        testSend(AirlockMessageGenerator.generateAirlockMessage(), HttpStatus.SC_UNAUTHORIZED, "HackerApiKey");
    }

    @Test
    public void emptyApiKey() throws Exception {
        testSend(AirlockMessageGenerator.generateAirlockMessage(), HttpStatus.SC_UNAUTHORIZED, null);
    }
    ...
    private void testSend(AirlockMessage message, int expectedStatus, String apiKey) throws Exception {
