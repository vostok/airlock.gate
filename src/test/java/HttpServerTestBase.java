...
public class HttpServerTestBase {
    ...
    public static void init() throws Exception {
        ...
        final HttpServer httpServer = new HttpServer(eventSenderMock, validatorFactory, false, appProperties);
...
//    }
    ...
    protected void testSend(AirlockMessage message, int expectedStatus, String apiKey) throws Exception {
